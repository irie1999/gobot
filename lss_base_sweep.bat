...
python run_signals_holdout_all.py --both --min-price 1000 --price-ranges 6000,0 --lss-proposal lss_proposal_%BM%.py --long-base %LB% --no-mirror --force --no-news --no-browser --no-serve --output-suffix _base%BM%
goto :eof
