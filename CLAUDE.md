...
**半導体も最悪業種も除外しない。33業種の除外ルールを作らない。同業種の集中上限も
設けない。業種経路は閉じる。** 再検討したくなったら上のコマンドを1回流せば同じ表が出る。
**掘り直す前にこの節を読むこと。**
