...
| **今日の転換結果を出す** | **`python tenkan_today.py --orders-csv orders_<日付>.csv`** | `.\fills` の後 | §18.5.2 |
...
python tenkan_today.py --orders-csv orders_20260805.csv    # 未約定の売り注文を自動抽出
python tenkan_today.py --date 2026-08-05 --symbols 3036,3132,...   # 直接指定
```
