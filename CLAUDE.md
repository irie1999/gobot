...
#### なぜ棄却したか — 厳密OOSで5倍率すべて悪化

順位表を **直近120日を除外**して作り(`--holdout-days 120`)、2026-05以降で検証:

| 倍率 | A 従来 | B ①のみ | C ①+② |
|---|---|---|---|
| x1.0 | **+1,691,277** | +1,680,675 | +1,466,040 |
| x1.5 | **+1,988,402** | +1,944,128 | +1,804,232 |
| **x2.0(運用点)** | **+2,180,127** | +2,111,519 | +2,009,717 |
| x2.5 | **+2,208,533** | +2,129,656 | +2,051,882 |
| x3.0 | **+2,294,579** | +2,166,114 | +2,158,808 |

**A > B > C が5倍率すべてで成立**。しかも TRAIN では B/C が A を上回る
(x2.0: A +2,282,836 / B +2,489,949 / C +2,475,379)。**TRAIN改善・OOS悪化 =
過剰適合の教科書的な形**。
