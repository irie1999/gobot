...
STOP_WATCHLIST: list[tuple[str, str, str]] = [
    # ── MACD (逆指値B) ── 99銘柄通過 上位10
    ("5706.T", "三井金属",                       "MACD"),  # 54,900円 folds=2 PnL=+3,106,786 PF=6.06 WR=80.6%
    ("6387.T", "サムコ",                         "MACD"),  # 13,170円 folds=2 PnL=+835,301   PF=4.94 WR=75.2%
    ("6278.T", "ユニオンツール",                 "MACD"),  # 18,360円 folds=2 PnL=+719,254   PF=4.79 WR=71.9%
    ("4062.T", "イビデン",                       "MACD"),  # 17,060円 folds=2 PnL=+622,837   PF=5.89 WR=80.0%
    ("7236.T", "ティラド",                       "MACD"),  # 14,800円 folds=2 PnL=+409,965   PF=3.94 WR=75.0%
    ("6941.T", "山一電機",                       "MACD"),  # 11,180円 folds=2 PnL=+372,115   PF=2.99 WR=71.0%
    ("6525.T", "ＫＯＫＵＳＡＩ　ＥＬＥＣＴＲＩＣ",  "MACD"),  #  6,170円 folds=2 PnL=+371,792   PF=3.36 WR=71.7%
    ("6101.T", "ツガミ",                         "MACD"),  #  6,260円 folds=2 PnL=+343,916   PF=8.81 WR=95.2%
    ("9766.T", "コナミグループ",                 "MACD"),  # 20,160円 folds=2 PnL=+328,046   PF=1.58 WR=51.1%
    ("6875.T", "メガチップス",                   "MACD"),  # 11,790円 folds=2 PnL=+301,425   PF=5.55 WR=75.6%
    # ── A7 (逆指値B) ── 58銘柄通過 上位10
    ("2692.T", "伊藤忠食品",                     "A7"),    # 12,920円 folds=2 PnL=+412,858   PF=4.76 WR=62.2%
    ("7003.T", "三井Ｅ＆Ｓ",                     "A7"),    #  5,560円 folds=2 PnL=+385,295   PF=5.33 WR=80.6%
    ("7173.T", "東京きらぼしフィナンシャルグループ","A7"),  # 10,550円 folds=2 PnL=+367,438   PF=2.84 WR=65.8%
    ("1801.T", "大成建設",                       "A7"),    # 17,855円 folds=2 PnL=+317,154   PF=2.39 WR=64.4%
    ("6101.T", "ツガミ",                         "A7"),    #  6,260円 folds=2 PnL=+312,914   PF=8.16 WR=88.9%
    ("2737.T", "トーメンデバイス",               "A7"),    # 15,640円 folds=2 PnL=+260,994   PF=2.61 WR=72.2%
    ("8360.T", "山梨中央銀行",                   "A7"),    #  5,740円 folds=2 PnL=+242,540   PF=3.85 WR=78.3%
    ("8361.T", "大垣共立銀行",                   "A7"),    #  7,370円 folds=2 PnL=+215,440   PF=7.30 WR=78.3%
    ("6103.T", "オークマ",                       "A7"),    #  4,760円 folds=2 PnL=+209,298   PF=7.58 WR=93.3%
    ("8227.T", "しまむら",                       "A7"),    #  3,135円 folds=2 PnL=+169,480   PF=4.99 WR=80.6%
    # ── RSI2 (逆指値B) ── 24銘柄通過 上位10
    ("5801.T", "古河電気工業",                   "RSI2"),  # 58,130円 folds=2 PnL=+1,161,433 PF=7.22 WR=88.9%
    ("9766.T", "コナミグループ",                 "RSI2"),  # 20,160円 folds=2 PnL=+530,294   PF=4.93 WR=58.3%
    ("2326.T", "デジタルアーツ",                 "RSI2"),  #  4,110円 folds=2 PnL=+344,788   PF=4.67 WR=55.6%
    ("9869.T", "加藤産業",                       "RSI2"),  #  5,980円 folds=2 PnL=+272,813   PF=5.85 WR=82.2%
    ("7003.T", "三井Ｅ＆Ｓ",                     "RSI2"),  #  5,560円 folds=2 PnL=+269,037   PF=5.06 WR=69.4%
    ("8877.T", "エスリード",                     "RSI2"),  #  5,620円 folds=3 PnL=+256,071   PF=7.12 WR=83.3%
    ("7011.T", "三菱重工業",                     "RSI2"),  #  4,406円 folds=2 PnL=+187,381   PF=5.32 WR=83.3%
    ("7012.T", "川崎重工業",                     "RSI2"),  #  3,417円 folds=3 PnL=+162,918   PF=4.89 WR=78.3%
    ("8551.T", "北日本銀行",                     "RSI2"),  #  4,975円 folds=2 PnL=+154,308   PF=4.81 WR=69.4%
    ("3496.T", "アズーム",                       "RSI2"),  #  4,230円 folds=2 PnL=+120,365   PF=4.46 WR=63.9%
]

BRK_WATCHLIST: list[tuple[str, str, str]] = [
    # ── DON (ブレイクアウト) ── 49銘柄通過 上位10
    ("6146.T", "ディスコ",                       "DON"),   # 72,840円 folds=3 PnL=+2,201,095 PF=4.39 WR=77.8%
    ("4062.T", "イビデン",                       "DON"),   # 17,060円 folds=2 PnL=+721,256   PF=5.88 WR=75.6%
    ("8360.T", "山梨中央銀行",                   "DON"),   #  5,740円 folds=3 PnL=+304,402   PF=7.05 WR=77.5%
    ("5715.T", "古河機械金属",                   "DON"),   #  4,075円 folds=2 PnL=+288,899   PF=7.79 WR=85.0%
    ("7236.T", "ティラド",                       "DON"),   # 14,800円 folds=2 PnL=+199,280   PF=4.33 WR=72.2%
    ("5535.T", "ミガロホールディングス",           "DON"),   #    291円 folds=2 PnL=+149,141   PF=4.21 WR=45.8%
    ("2802.T", "味の素",                         "DON"),   #  5,483円 folds=3 PnL=+148,598   PF=3.46 WR=71.1%
    ("6284.T", "日精エー・エス・ビー機械",         "DON"),   #  8,190円 folds=2 PnL=+144,459   PF=4.88 WR=75.0%
    ("1815.T", "鉄建建設",                       "DON"),   #  4,955円 folds=2 PnL=+138,865   PF=3.03 WR=70.0%
    ("6268.T", "ナブテスコ",                     "DON"),   #  5,737円 folds=2 PnL=+133,022   PF=2.78 WR=66.7%
    # ── VOL (ブレイクアウト) ── 25銘柄通過 上位10
    ("5802.T", "住友電気工業",                   "VOL"),   # 12,775円 folds=3 PnL=+543,686   PF=6.14 WR=80.6%
    ("4062.T", "イビデン",                       "VOL"),   # 17,060円 folds=3 PnL=+520,446   PF=8.10 WR=88.9%
    ("7236.T", "ティラド",                       "VOL"),   # 14,800円 folds=2 PnL=+232,945   PF=4.61 WR=75.6%
    ("1515.T", "日鉄鉱業",                       "VOL"),   #  2,516円 folds=2 PnL=+185,014   PF=5.92 WR=83.3%
    ("3741.T", "セック",                         "VOL"),   #  3,755円 folds=2 PnL=+165,275   PF=5.52 WR=75.0%
    ("6268.T", "ナブテスコ",                     "VOL"),   #  5,737円 folds=2 PnL=+157,963   PF=6.36 WR=77.8%
    ("5715.T", "古河機械金属",                   "VOL"),   #  4,075円 folds=2 PnL=+154,774   PF=7.35 WR=91.7%
    ("1942.T", "関電工",                         "VOL"),   #  7,267円 folds=2 PnL=+122,212   PF=4.97 WR=83.3%
    ("2726.T", "パルグループホールディングス",     "VOL"),   #  1,439円 folds=2 PnL=+110,377   PF=6.07 WR=83.3%
    ("6323.T", "ローツェ",                       "VOL"),   #  3,946円 folds=2 PnL=+109,444   PF=4.46 WR=75.6%
    # ── MOM (ブレイクアウト) ── 19銘柄通過 上位10
    ("6101.T", "ツガミ",                         "MOM"),   #  6,260円 folds=2 PnL=+329,185   PF=7.39 WR=88.9%
    ("1515.T", "日鉄鉱業",                       "MOM"),   #  2,516円 folds=2 PnL=+302,592   PF=7.61 WR=86.7%
    ("3563.T", "ＦＯＯＤ　＆　ＬＩＦＥ",         "MOM"),   # 10,800円 folds=2 PnL=+300,989   PF=4.14 WR=68.6%
    ("9412.T", "スカパーＪＳＡＴ",               "MOM"),   #  4,205円 folds=2 PnL=+157,454   PF=3.41 WR=75.5%
    ("8522.T", "名古屋銀行",                     "MOM"),   #  5,870円 folds=2 PnL=+133,652   PF=2.75 WR=70.0%
    ("8360.T", "山梨中央銀行",                   "MOM"),   #  5,740円 folds=2 PnL=+131,975   PF=4.62 WR=74.6%
    ("8387.T", "四国銀行",                       "MOM"),   #  2,661円 folds=2 PnL=+95,988    PF=5.81 WR=83.3%
    ("8237.T", "松屋",                           "MOM"),   #  1,548円 folds=3 PnL=+92,578    PF=2.70 WR=73.8%
    ("7453.T", "良品計画",                       "MOM"),   #  3,492円 folds=2 PnL=+87,491    PF=2.60 WR=63.3%
    ("1961.T", "三機工業",                       "MOM"),   #  2,596円 folds=2 PnL=+76,378    PF=4.39 WR=72.2%
]
