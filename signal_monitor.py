...
# ── 監視銘柄（A7バックテスト 利益率ランキング上位30銘柄） ────
# 2026-03-25 スキャン結果
WATCH_LIST = [
    ("6326.T",  "クボタ"),             #  1位 +42.1%
    ("5101.T",  "横浜ゴム"),           #  2位 +34.5%
    ("6473.T",  "ジェイテクト"),       #  3位 +31.1%
    ("8830.T",  "住友不動産"),         #  4位 +29.9%
    ("3105.T",  "日清紡HD"),           #  5位 +29.7%
    ("8267.T",  "イオン"),             #  6位 +27.0%
    ("7202.T",  "いすゞ自動車"),       #  7位 +25.5%
    ("8802.T",  "三菱地所"),           #  8位 +24.9%
    ("6305.T",  "日立建機"),           #  9位 +24.1%
    ("8304.T",  "あおぞら銀行"),       # 10位 +22.2%
    ("4506.T",  "住友ファーマ"),       # 11位 +21.9%
    ("6506.T",  "安川電機"),           # 12位 +21.5%
    ("6103.T",  "オークマ"),           # 13位 +20.6%
    ("3289.T",  "東急不動産HD"),       # 14位 +20.5%
    ("1803.T",  "清水建設"),           # 15位 +19.5%
    ("4004.T",  "レゾナック・HD"),     # 16位 +19.4%
    ("9532.T",  "大阪ガス"),           # 17位 +19.4%
    ("6471.T",  "日本精工"),           # 18位 +19.0%
    ("4503.T",  "アステラス製薬"),     # 19位 +18.7%
    ("6302.T",  "住友重機械工業"),     # 20位 +18.4%
    ("1802.T",  "大林組"),             # 21位 +18.2%
    ("8233.T",  "高島屋"),             # 22位 +17.3%
    ("6752.T",  "パナソニックHD"),     # 23位 +16.8%
    ("4902.T",  "コニカミノルタ"),     # 24位 +16.4%
    ("9502.T",  "中部電力"),           # 25位 +15.6%
    ("7013.T",  "IHI"),                # 26位 +14.6%
    ("8002.T",  "丸紅"),               # 27位 +14.6%
    ("7731.T",  "ニコン"),             # 28位 +14.3%
    ("6971.T",  "京セラ"),             # 29位 +14.1%
    ("8628.T",  "松井証券"),           # 30位 +12.7%
]
