...
# 2026-03-25 スキャン結果
WATCH_LIST = [
    # ── 2026年3月 相場分析に基づく最強銘柄（詳細分析版）────────────
    # 【銀行】BOJ利上げ継続。各社最高益ペース
    ("8316.T",  "三井住友FG"),           # 純利益+29% YoY、最強モメンタム
    ("8306.T",  "三菱UFJFG"),            # Q3進捗86%、年初来高値¥3,087
    ("8411.T",  "みずほFG"),             # 初の1兆円純利益達成ペース
    # 【重工・防衛】防衛予算GDP2%達成、バックログ積み上げ
    ("7011.T",  "三菱重工業"),           # +137% 1年、ATH¥5,208からの押し目
    ("7013.T",  "IHI"),                  # 時価総額3.5年で6倍、航空エンジン+防衛
    # 【保険】金利上昇+円安で運用益拡大
    ("8766.T",  "東京海上HD"),           # 保険×金利恩恵、安定配当
    ("8725.T",  "MS&ADインシュアランス"), # 同セクター2番手
    # 【半導体・装置】高ボラ注意だが需要堅調
    ("8035.T",  "東京エレクトロン"),     # PER31x、CEO「2026年最高の年」
    # 【建設】国内需要・防衛インフラ・ディフェンシブ
    ("1812.T",  "鹿島建設"),             # 防衛施設・国土強靭化
    ("1801.T",  "大成建設"),             # 同セクター
]
