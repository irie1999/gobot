...
STOP_WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("9305.T", "ヤマタネ",                       "RSI2"),  # 2,024円 folds=2 PnL=+69,411  PF=6.67 WR=67%
    ("6486.T", "イーグル工業",                   "RSI2"),  # 2,920円 folds=2 PnL=+63,368  PF=10.0 WR=100%
...
BRK_WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("6532.T", "ベイカレント",                   "VOL"),   # 5,082円 folds=2 PnL=+123,124 PF=3.31 WR=50%
    # ── MOM (ブレイクアウト) ──
