...
除外基準: 取引回数が少ない銘柄・損益マイナス銘柄・低株価で1トレード利益が小さすぎる銘柄は手動除外し代替補充。
...
STOP_WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("6788.T", "日本トリム",                     "RSI2"),  # 4,405円 folds=2 PnL=+93,753  PF=6.13 WR=78%
    ("8919.T", "カチタス",                       "RSI2"),  # 3,645円 folds=2 PnL=+73,987  PF=2.75 WR=71%
]
...
BRK_WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("1942.T", "関電工",                         "VOL"),   # 7,366円 folds=2 PnL=+106,614 PF=4.73 WR=85%
    # ── MOM (ブレイクアウト) ──
    ...
    ("1975.T", "朝日工業社",                     "MOM"),   # 3,855円 folds=3 PnL=+122,817 PF=4.89 WR=74%
]
