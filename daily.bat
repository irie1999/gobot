...
REM Base month = 2026-06 (lss_proposal_2026-06.py). Generate it first with:
REM   python scan_lss_universe.py --base-month 2026-06 --out lss_proposal_2026-06.py --max-price 6000 --source local
REM (or run .\lss_base_sweep.bat which also regenerates it with the latest fixes).
