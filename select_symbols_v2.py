...
WORKERS = 4   # 16だとyfinanceレート制限で全銘柄同一データになる
...
""")
    ...
    if args.v1:
        ...
        # --v1 時のデフォルト監視リストファイル名（日経225専用）
        macd_watch_file  = "symbols_watch_225.py"
        a7_watch_file    = "symbols_watch_a7_225.py"
        rsi2_watch_file  = "symbols_watch_rsi2_225.py"
        ver_label = "V1（日経225）"
