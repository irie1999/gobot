...
ap.add_argument("--sm-list", type=str, default="0.25,0.5,1.0",
                help="損切り幅%%(ショートなので建値の上)")
ap.add_argument("--tm-list", type=str, default="0.5,1.0,2.0",
                help="利確幅%%(建値の下)")
...
print(f"  → 日足の悲観仮定は、この分だけ **低く出る**。")
print(f"     ✅ 日足で合格が出たなら本当はもっと良い(安全側)")
print(f"     ⛔ **日足で合格が出なくても『バリアに意味がない』の証明にはならない**")
