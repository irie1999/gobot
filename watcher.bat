...
REM     .\watcher                    SAFE  : dry-run + demo (no real orders; check display)
REM     .\watcher --execute --prod   LIVE  : real stop/target/close + budget cancel on PROD
REM
REM   Always applied:
...
REM   Pass-through: anything after .\watcher is forwarded (e.g. --execute --prod --poll 3).
REM ============================================================
python lss_exit_watcher.py --budget-cap 4000000 --stop-delay-bars 1 %*
