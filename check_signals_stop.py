...
WATCHLIST: list[tuple[str, str, str]] = [
    # ── MACD Walk-forward選定 (2026-05-19, budget≤50万, conservative) ──
    ...
    # ── A7 Walk-forward選定 (2026-05-19, budget≤50万, conservative) ──
    ...
    # ── RSI2 Walk-forward選定 (2026-05-19, budget≤50万, conservative) ──
