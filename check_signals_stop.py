...
WATCHLIST: list[tuple[str, str, str]] = [
    # ── MACD 逆指値B スキャン上位（複数期間安定）──
    ("4680.T", "ラウンドワン",           "MACD"),   # #1  365d 100%
    ("5821.T", "平河ヒューテック",       "MACD"),   # #2  30+90+365d 91-100%
    ("4368.T", "扶桑化学工業",           "MACD"),   # #3  30+90+365d 90-100%
    ("7762.T", "シチズン時計",           "MACD"),   # #4  30+90+365d 88-100%
    ("3395.T", "サンマルクHD",           "MACD"),   # #5  90+180+365d 85-100%
    ("4023.T", "クレハ",                 "MACD"),   # #6  90+180+365d 100%
    ("4044.T", "セントラル硝子",         "MACD"),   # #7  90+180+365d 100%
    ("4186.T", "東京応化工業",           "MACD"),   # #9  90+180+365d 100% +392K
    ("6871.T", "日本マイクロニクス",     "MACD"),   # #13 90+180+365d 100% +828K
    ("6136.T", "オーエスジー",           "MACD"),   # #12 90+180+365d 100%
    # ── A7 逆指値B スキャン上位（複数期間安定）──
    ("6752.T", "パナソニックHD",         "A7"),     # #7  30+90+365d 100%
    ("6920.T", "レーザーテック",         "A7"),     # #12 全4期間 87-100% +2.08M
    ("6702.T", "富士通",                 "A7"),     # #6  180+365d 100%
    ("7974.T", "任天堂",                 "A7"),     # #8  365d 100% +354K
    ("1861.T", "熊谷組",                 "A7"),     # #10 180+365d 88-100%
    ("7384.T", "プロクレアHD",           "A7"),     # #15 90+180+365d 80-100%
    ("4028.T", "石原産業",               "A7"),     # #11 180+365d 85-100%
    ("9984.T", "ソフトバンクグループ",   "A7"),     # #9  365d 100%
    # ── RSI2 逆指値B スキャン上位（複数期間安定）──
    ("3132.T", "マクニカHD",             "RSI2"),   # #1  180+365d 100%
    ("7167.T", "めぶきフィナンシャルG", "RSI2"),   # #4  30+90+180+365d 100%
    ("9508.T", "九州電力",               "RSI2"),   # #13 90+180+365d 100%
    ("1301.T", "極洋",                   "RSI2"),   # #14 180+365d 100%
    ("1605.T", "INPEX",                  "RSI2"),   # #15 180+365d 100%
    ("4189.T", "KHネオケム",             "RSI2"),   # #2  365d 100%
    ("4220.T", "リケンテクノス",         "RSI2"),   # #3  365d 100%
]
