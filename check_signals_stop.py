...
WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("7003.T", "三井Ｅ＆Ｓ",                             "A7"),    # folds=2  12取引 PF7.15 WR90%  DD6.6%
    ("6752.T", "パナソニックホールディングス",           "A7"),    # folds=2   9取引 PF10.0 WR100% DD0.0% ※取引数少
    ("8360.T", "山梨中央銀行",                           "A7"),    # folds=2  18取引 PF3.51 WR72%  DD12.7%
    ("4506.T", "住友ファーマ",                           "A7"),    # folds=2  10取引 PF6.78 WR86%  DD2.4%
    ("6101.T", "ツガミ",                                 "A7"),    # folds=2  20取引 PF4.52 WR75%  DD13.2%
    ("1814.T", "大末建設",                               "A7"),    # folds=2  12取引 PF6.76 WR89%  DD4.3%
    ("8173.T", "Ｊｏｓｈｉｎ",                           "A7"),    # folds=2  21取引 PF4.51 WR86%  DD2.3%
    ("9956.T", "バローホールディングス",                 "A7"),    # folds=2  18取引 PF4.12 WR68%  DD2.9%
    ("8544.T", "京葉銀行",                               "A7"),    # folds=2  15取引 PF6.72 WR89%  DD6.1%
    ("5831.T", "しずおかフィナンシャルグループ",         "A7"),    # folds=2   9取引 PF6.49 WR88%  DD1.9% ※取引数少
    # ── RSI2: Walk-forward 選定 (2026-06-04, 価格上限なし) ──
    ("3563.T", "ＦＯＯＤ　＆　ＬＩＦＥ　ＣＯＭＰＡＮＩＥＳ", "RSI2"),  # folds=2  12取引 PF10.0 WR83%  DD3.6%
    ("8309.T", "三井住友トラストグループ",               "RSI2"),  # folds=2   8取引 PF10.0 WR100% DD0.0% ※取引数少
    ("8061.T", "西華産業",                               "RSI2"),  # folds=2  15取引 PF10.0 WR100% DD0.0%
    ("5482.T", "愛知製鋼",                               "RSI2"),  # folds=2  12取引 PF3.53 WR72%  DD6.4%
    ("5821.T", "平河ヒューテック",                       "RSI2"),  # folds=2   8取引 PF3.88 WR73%  DD5.2%
    ("9960.T", "東テク",                                 "RSI2"),  # folds=2  20取引 PF2.87 WR75%  DD5.9%
    ("6501.T", "日立製作所",                             "RSI2"),  # folds=2  14取引 PF1.95 WR65%  DD13.3%
    ("6237.T", "イワキポンプ",                           "RSI2"),  # folds=2   9取引 PF5.75 WR68%  DD5.3%
    ("2540.T", "養命酒製造",                             "RSI2"),  # folds=2  10取引 PF6.09 WR63%  DD6.0%
    ("8393.T", "宮崎銀行",                               "RSI2"),  # folds=2   6取引 PF10.0 WR100% DD0.0% ※取引数少
    # ── MACD: Walk-forward 選定 (2026-06-04, 価格上限なし) ──
    ("6278.T", "ユニオンツール",                         "MACD"),  # folds=2  24取引 PF3.49 WR79%  DD13.9%
    ("9531.T", "東京瓦斯",                               "MACD"),  # folds=2  11取引 PF6.74 WR86%  DD5.0%
    ("1515.T", "日鉄鉱業",                               "MACD"),  # folds=2  20取引 PF2.61 WR65%  DD12.0%
    ("9072.T", "ニッコンホールディングス",               "MACD"),  # folds=2   9取引 PF7.86 WR83%  DD4.0%
    ("8377.T", "ほくほくフィナンシャルグループ",         "MACD"),  # folds=2  12取引 PF2.92 WR58%  DD10.5%
    ("7322.T", "三十三フィナンシャルグループ",           "MACD"),  # folds=2  14取引 PF7.36 WR79%  DD1.7%
    ("5482.T", "愛知製鋼",                               "MACD"),  # folds=2  15取引 PF2.21 WR67%  DD6.7%
    ("1417.T", "ミライト・ワン",                         "MACD"),  # folds=2  15取引 PF2.20 WR73%  DD8.5%
    ("7157.T", "ライフネット生命保険",                   "MACD"),  # folds=2   9取引 PF2.68 WR67%  DD6.7%
    ("6914.T", "オプテックスグループ",                   "MACD"),  # folds=2  22取引 PF1.96 WR68%  DD7.8%
]
