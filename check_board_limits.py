...
# ⛔ **上場廃止銘柄を入れないこと**(2026-09-07)。kabu の /register は
#   部分受理しないので、1件でも無効なコードがあると **PUT 全体が 400**
#   で落ちる。5486(日立金属 / 2023年上場廃止)が残っていたせいで
#   kabu_ws --rotate の3バッチ目が丸ごと測定不能になった。
_DEFAULT = [
    ...
    5332, 5333, 5411, 5541, 5631, 5632, 5703, 5706, 5711, 5713,
    5714, 5801, 5802, 5803, 5901, 6103, 6113, 6136, 6141, 6146,
]
