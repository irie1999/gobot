...
WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("7242.T", "カヤバ",                             "MOM"),  # folds=2  28取引 PF2.75 WR71%  DD7.6%
    ("6762.T", "ＴＤＫ",                             "MOM"),  # folds=2  27取引 PF4.95 WR75%  DD7.8%
    ("8237.T", "松屋",                               "MOM"),  # folds=2  35取引 PF2.93 WR75%  DD8.1%
    ("7966.T", "リンテック",                         "MOM"),  # folds=2  22取引 PF1.68 WR67%  DD13.2%
    ("4554.T", "富士製薬工業",                       "MOM"),  # folds=2  25取引 PF2.48 WR72%  DD3.4%
    ("3964.T", "オークネット",                       "MOM"),  # folds=2  36取引 PF1.71 WR65%  DD4.4%
    # ── DON: Walk-forward 選定 (2026-06-04, 価格上限なし) ──
    ("6875.T", "メガチップス",                       "DON"),  # folds=2  31取引 PF4.00 WR75%  DD11.6%
    ("1515.T", "日鉄鉱業",                           "DON"),  # folds=2  25取引 PF2.59 WR68%  DD10.9%
    # ── VOL: Walk-forward 選定 (2026-06-04, 価格上限なし) ──
    ("4461.T", "第一工業製薬",                       "VOL"),  # folds=2  12取引 PF7.17 WR85%  DD8.4%
    ("7013.T", "ＩＨＩ",                             "VOL"),  # folds=2  13取引 PF3.29 WR77%  DD6.2%
    ("4390.T", "ＩＰＳ",                             "VOL"),  # folds=2   9取引 PF4.21 WR78%  DD4.8%
    ("9887.T", "松屋フーズホールディングス",         "VOL"),  # folds=2   7取引 PF7.73 WR90%  DD3.6%
    ("6284.T", "日精エー・エス・ビー機械",           "VOL"),  # folds=2   7取引 PF2.16 WR71%  DD10.1%
    ("1803.T", "清水建設",                           "VOL"),  # folds=2   8取引 PF3.94 WR63%  DD3.4%
    ("1945.T", "東京エネシス",                       "VOL"),  # folds=2  21取引 PF1.88 WR67%  DD10.7%
    ("9843.T", "ニトリホールディングス",             "VOL"),  # folds=2   9取引 PF5.73 WR75%  DD5.9%
    ("6952.T", "カシオ計算機",                       "VOL"),  # folds=2   7取引 PF3.80 WR71%  DD1.3%
]
