...
WATCHLIST: list[tuple[str, str, str]] = [
    # ── DON Walk-forward選定 (2026-05-19, budget≤50万, conservative) ──
    ...
    # ── VOL Walk-forward選定 (2026-05-19, budget≤50万, conservative) ──
    # ※4680.T(ラウンドワン)は6取引のみのため除外→9025.T(鴻池運輸)で代替
    ...
    # ── MOM Walk-forward選定 (2026-05-19, budget≤50万, conservative) ──
    # ※8016.T(オンワードHD)は取引数少・総利益小のため除外、代替なし
