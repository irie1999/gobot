...
WATCHLIST: list[tuple[str, str, str]] = [
    # ── DON: Walk-forward 選定 (2026-05-20) ──
    ("7173.T", "東京きらぼしフィナンシャルグループ", "DON"),
    ("5802.T", "住友電気工業",                       "DON"),
    ("8360.T", "山梨中央銀行",                       "DON"),
    ("8377.T", "ほくほくフィナンシャルグループ",     "DON"),
    ("1515.T", "日鉄鉱業",                           "DON"),
    ("4186.T", "東京応化工業",                       "DON"),
    ("8386.T", "百十四銀行",                         "DON"),
    ("6134.T", "ＦＵＪＩ",                           "DON"),
    ("4203.T", "住友ベークライト",                   "DON"),
    ("1980.T", "ダイダン",                           "DON"),
    # ── VOL: Walk-forward 選定 (2026-05-20) ──
    ("4072.T", "電算システムホールディングス",       "VOL"),
    ("6310.T", "井関農機",                           "VOL"),
    ("5802.T", "住友電気工業",                       "VOL"),
    ("7013.T", "ＩＨＩ",                             "VOL"),
    ("8157.T", "都築電気",                           "VOL"),
    ...
    ("3099.T", "三越伊勢丹ホールディングス",         "VOL"),
    # ── MOM: Walk-forward 選定 (2026-05-20) ──
    ("8360.T", "山梨中央銀行",                       "MOM"),
    ("8377.T", "ほくほくフィナンシャルグループ",     "MOM"),
    ("6101.T", "ツガミ",                             "MOM"),
    ("3659.T", "ネクソン",                           "MOM"),
    ("9412.T", "スカパーＪＳＡＴ",                   "MOM"),
    ("8522.T", "名古屋銀行",                         "MOM"),
