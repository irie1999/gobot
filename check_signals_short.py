...
WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("6861.T", "キーエンス",           "MACD_S"),
    ("7203.T", "トヨタ自動車",         "MACD_S"),
    ("6758.T", "ソニーグループ",       "MACD_S"),
    ("8306.T", "三菱UFJ FG",           "MACD_S"),
    ("6367.T", "ダイキン工業",         "MACD_S"),
    ("4063.T", "信越化学工業",         "MACD_S"),
    ("7974.T", "任天堂",               "MACD_S"),
    ("5988.T", "パイオラックス",       "MACD_S"),
    # ── A7_S: ストキャス反転売り ──
    ("6501.T", "日立製作所",           "A7_S"),
    ("6503.T", "三菱電機",             "A7_S"),
    ("7751.T", "キヤノン",             "A7_S"),
