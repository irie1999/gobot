...
WATCHLIST: list[tuple[str, str, str]] = [
    # ── MACD_S: MACDデッドクロス売り (株価5,000円以下・流動性重視) ──
    ("7203.T", "トヨタ自動車",         "MACD_S"),  # ~3,500円
    ("6758.T", "ソニーグループ",       "MACD_S"),  # ~2,500円
    ("8306.T", "三菱UFJ FG",           "MACD_S"),  # ~1,800円
    ("8058.T", "三菱商事",             "MACD_S"),  # ~2,500円
    ("7267.T", "本田技研工業",         "MACD_S"),  # ~1,400円
    ("8031.T", "三井物産",             "MACD_S"),  # ~2,800円
    ("7011.T", "三菱重工業",           "MACD_S"),  # ~2,500円
    ("9101.T", "日本郵船",             "MACD_S"),  # ~4,500円
    # ── A7_S: ストキャス反転売り (株価5,000円以下・mean reversion向き) ──
    ("6501.T", "日立製作所",           "A7_S"),    # ~4,500円
    ("6503.T", "三菱電機",             "A7_S"),    # ~2,500円
    ("7751.T", "キヤノン",             "A7_S"),    # ~4,500円
    ("9432.T", "NTT",                  "A7_S"),    # ~150円
    ("6645.T", "オムロン",             "A7_S"),    # ~3,500円
    ("8411.T", "みずほFG",             "A7_S"),    # ~3,500円
    ("6902.T", "デンソー",             "A7_S"),    # ~2,500円
    ("6702.T", "富士通",               "A7_S"),    # ~3,500円
    # ── RSI2_S: RSI2 買われすぎ反転売り (株価5,000円以下・短期反落向き) ──
    ("4568.T", "第一三共",             "RSI2_S"),  # ~4,500円
    ("5401.T", "日本製鉄",             "RSI2_S"),  # ~3,500円
    ("6326.T", "クボタ",               "RSI2_S"),  # ~2,000円
    ("4502.T", "武田薬品工業",         "RSI2_S"),  # ~4,000円
    ("9020.T", "JR東日本",             "RSI2_S"),  # ~3,000円
    ("7270.T", "SUBARU",               "RSI2_S"),  # ~2,500円
    ("8002.T", "丸紅",                 "RSI2_S"),  # ~2,800円
    ("9104.T", "商船三井",             "RSI2_S"),  # ~4,500円
]
