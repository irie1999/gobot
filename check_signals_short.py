...
WATCHLIST: list[tuple[str, str, str]] = [
    ...
    ("7203.T", "トヨタ自動車",   "A7_S"),  # ~3,500円
    ("6758.T", "ソニーグループ", "A7_S"),  # ~2,500円
    ("8306.T", "三菱UFJ FG",     "A7_S"),  # ~1,800円
    ("7267.T", "本田技研工業",   "A7_S"),  # ~1,400円
    ("8058.T", "三菱商事",       "A7_S"),  # ~2,500円
    ("8031.T", "三井物産",       "A7_S"),  # ~2,800円
    ("7011.T", "三菱重工業",     "A7_S"),  # ~2,500円
    ("4568.T", "第一三共",       "A7_S"),  # ~4,500円
    ("5401.T", "日本製鉄",       "A7_S"),  # ~3,500円
    ("4502.T", "武田薬品工業",   "A7_S"),  # ~4,000円
    ("9020.T", "JR東日本",       "A7_S"),  # ~3,000円
    ("8002.T", "丸紅",           "A7_S"),  # ~2,800円
]
